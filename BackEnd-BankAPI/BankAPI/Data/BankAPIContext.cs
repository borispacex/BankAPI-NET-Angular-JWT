        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Account>(entity =>
            {
                ...
                entity.HasOne(d => d.AccountTypeNavigation)
                    ...
                    .HasConstraintName("FK__Account__Account__33D4B598");

                entity.HasOne(d => d.Client)
                    .WithMany(p => p.Accounts)
                    .HasForeignKey(d => d.ClientId)
                    .HasConstraintName("FK__Account__ClientI__34C8D9D1");
            });
            ...
            modelBuilder.Entity<BankTransaction>(entity =>
            {
                ...
                entity.HasOne(d => d.Account)
                    ...
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__BankTrans__Accou__35BCFE0A");

                entity.HasOne(d => d.TransactionTypeNavigation)
                    .WithMany(p => p.BankTransactions)
                    .HasForeignKey(d => d.TransactionType)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__BankTrans__Trans__36B12243");
            });
            ...
            modelBuilder.Entity<Departamento>(entity =>
            {
                entity.HasKey(e => e.IdDepartamento)
                    .HasName("PK__Departam__787A433D92ADB9C3");
            ...
            modelBuilder.Entity<Empleado>(entity =>
            {
                entity.HasKey(e => e.IdEmpleado)
                    .HasName("PK__Empleado__CE6D8B9E046D322B");
                ...
                entity.HasOne(d => d.IdDepartamentoNavigation)
                    ...
                    .HasConstraintName("FK__Empleado__IdDepa__3C69FB99");
            });
